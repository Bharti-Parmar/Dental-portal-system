 ...
 ?>
    ...
    <div class="container">
      ...
      <form action="update-comments.php" method="POST" enctype="multipart/form-data">
      ...
      <input type="hidden" name="id" value="<?php echo $edit['0'];?>">
        ...
        <div class="form-group">
          ...
          <input type="comment" class="form-control" id="comments" value="<?php echo $edit['comments'];?>" name="comments">
        </div>
        <div class="form-group">
